...
import Admin.LearnTogether.Converter.UserConverter;
...
public class UserService implements IUserService {
    ...
    public UserService(UserRepo userRepository, UserConverter userConverter, PostRepo postRepository, BCryptPasswordEncoder passwordEncoder){
